...
<head>
    ...
    <title>EduCard: Admin/Teacher Login</title>
...
<body>
    ...
    <div class="container">
        ...
        <form action="5.php" class="login" method="POST" autocomplete="off">
           ...
           <!--<button class="btns">
            ...
            <!--<a href="6_teacher_signup.php">Don't you have an account? Create your account</a>-->
        </form>   
    </div>
    <?php 
       function redirect($username) {
        ...
        setTimeout(function() {
            window.location.replace('15_teacherlanding.php');
        }, 2000);
    </script>";
    }
...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "SELECT username, password FROM teacher_acc WHERE username='$username' AND password='$password'";
