...
$sql_science_flashcard = "SELECT subject, term, definition FROM science_teacher WHERE lesson_number = '$lessonNumber'";
$result_science_flashcard = mysqli_query($conn, $sql_science_flashcard);

$science_data = mysqli_fetch_all($result_science_flashcard, MYSQLI_ASSOC);
...
<a href="../14_editprofile.php" style="margin-bottom: 30px; font-size: 20px;">Settings</a>
    ...
    <h1>
        <?php echo $science_data[$currentPage]['subject']; ?>
    </h1>
