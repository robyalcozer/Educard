...
if (isset($_POST["lesson_number"])) {
    ...
    $insertquery = "INSERT INTO science(lesson_number, term, definition, added_by) VALUES (?, ?, ?, ?)";
...
if (isset($_POST['delete'])) {
    ...
    $deleteQuery = "DELETE FROM science WHERE lesson_number = '$lessonNumberToDelete' AND term = '$termToDelete' AND definition = '$definitionToDelete'";
...
<head>
    ...
    <title>Create: Science Flashcard</title>
