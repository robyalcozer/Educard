...
if (isset($_POST["question_count"])) {
    ...
    for ($i = 1; $i <= $_POST["question_count"]; $i++) {
        ...
        $insertquery = $conn->prepare("
            INSERT INTO math_quiz (correct_answer, question, choice1, choice2, choice3, choice4, quiz_number, quiz_title, timer)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
...
$sql_fetch_quiz = "SELECT quiz_number, subject, quiz_title FROM math_quiz GROUP BY quiz_number";
...
<body>
    ...
    <div class="container">
        <form method="POST" id="quiz-form">
            ...
            <input type="number" id="subject" name="subject" placeholder="Please enter a quiz number between 30 and 39."
                required style="width: 68%; height: 45px;" min="30" max="39"> <br>
    ...
    <script>
        ...
        function validateQuizNumber() {
            ...
            var isValid = quizNumber >= 30 && quizNumber <= 39;

            if (!isValid) {
                alert("Please enter a quiz number between 30 and 39.");
            }

            document.getElementById("createBtn").disabled = !isValid;

            quizNumberInput.setCustomValidity(isValid ? "" : "Please enter a quiz number between 30 and 39.");
        ...
        function generateQuestions() {
            ...
            for (var i = 1; i <= questionCount; i++) {
                var questionHtml = `
                    ...
                    <label for="choice4_${i}">Choice 4</label><br>
                    <input type="text" id="choice4_${i}" name="choice4_${i}" required
                        style="width: 60%; height: 45px;"><br>
