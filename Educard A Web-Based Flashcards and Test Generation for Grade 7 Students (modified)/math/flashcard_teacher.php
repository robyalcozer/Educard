...
$sql_math_flashcard = "SELECT subject, term, definition FROM math_teacher WHERE lesson_number = '$lessonNumber'";
$result_math_flashcard = mysqli_query($conn, $sql_math_flashcard);

$math_data = mysqli_fetch_all($result_math_flashcard, MYSQLI_ASSOC);

$totalPages = count($math_data);
...
<body>
    ...
    <h1>
        <?php echo $math_data[$currentPage]['subject']; ?>
    </h1>
    ...
    <script>
        ...
        var mathData = <?php echo json_encode($math_data); ?>;
        ...
        function updateContent() {
            ...
            term.textContent = mathData[currentPage]['term'];

            var popupContent = document.getElementById('popup-content');
            popupContent.textContent = mathData[currentPage]['definition'];
        }
