...
if (isset($_POST['create'])) {
    ...
    for ($i = 1; $i <= $questionCount; $i++) {
        ...
        $insertQuery = "INSERT INTO math_teacher (lesson_number, term, definition) 
...
if (isset($_POST['delete'])) {
    ...
    $deleteQuery = "DELETE FROM math_teacher WHERE lesson_number = '$lessonNumberToDelete' AND term = '$termToDelete' AND definition = '$definitionToDelete'";
...
<head>
    ...
    <title>Create: math Lesson</title>
...
<body>
    ...
    <div class="card-container">
        <?php
        $sql_select = "SELECT term, definition, lesson_number FROM math_teacher";
