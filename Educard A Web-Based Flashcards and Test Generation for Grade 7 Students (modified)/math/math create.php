...
if (isset($_POST["lesson_number"])) {
    ...
    $insertquery = "INSERT INTO math(lesson_number, term, definition, added_by) VALUES (?, ?, ?, ?)";
...
if (isset($_POST['delete'])) {
    ...
    $deleteQuery = "DELETE FROM math WHERE lesson_number = '$lessonNumberToDelete' AND term = '$termToDelete' AND definition = '$definitionToDelete'";
...
<head>
    ...
    <title>Create: math Flashcard</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="card-container">
            ...
            $sql_select = "SELECT term, definition, lesson_number FROM math WHERE added_by = '$username'";
