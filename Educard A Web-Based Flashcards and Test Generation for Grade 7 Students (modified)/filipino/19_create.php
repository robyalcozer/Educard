...
if (isset($_POST['create'])) {
    ...
    for ($i = 1; $i <= $questionCount; $i++) {
        ...
        $insertQuery = "INSERT INTO filipino_teacher (lesson_number, term, definition) 
...
if (isset($_POST['delete'])) {
    ...
    $deleteQuery = "DELETE FROM filipino_teacher WHERE lesson_number = '$lessonNumberToDelete' AND term = '$termToDelete' AND definition = '$definitionToDelete'";
...
<head>
    ...
    <title>Create: filipino Lesson</title>
...
<body>
    ...
    <div class="card-container">
        <?php
        $sql_select = "SELECT term, definition, lesson_number FROM filipino_teacher";
