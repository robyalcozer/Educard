...
$lessonNumber = isset($_GET['lesson_number']) ? $_GET['lesson_number'] : '';

$sql_filipino_flashcard = "SELECT subject, term, definition FROM filipino_teacher WHERE lesson_number = '$lessonNumber'";
$result_filipino_flashcard = mysqli_query($conn, $sql_filipino_flashcard);

$filipino_data = mysqli_fetch_all($result_filipino_flashcard, MYSQLI_ASSOC);

$totalPages = count($filipino_data);
...
<body>
    ...
    <img src="https://i.imgur.com/FQdzZM0.png" style="width: 50px; height: 65px;">
        ...
        <div class="navbar-icons">
            <a href="../9.php" style="font-size: 16px; margin-right:-20px;"><i
...
<a href="../14_editprofile.php" style="margin-bottom: 30px; font-size: 20px;">Settings</a>
    ...
    <h1>
        <?php echo $filipino_data[$currentPage]['subject']; ?>
    </h1>
    ...
    <div class="button-container">
        <button id="def" onclick="openPopup()">Click here to see definition</button>
    </div>
 ...
 document.addEventListener("DOMContentLoaded", function () {
    ...
    var filipinoData = <?php echo json_encode($filipino_data); ?>;
    ...
    function updateContent() {
        ...
        term.textContent = filipinoData[currentPage]['term'];

        var popupContent = document.getElementById('popup-content');
        popupContent.textContent = filipinoData[currentPage]['definition'];
    }
