...
$sql_english_flashcard = "SELECT subject, term, definition FROM english_teacher WHERE lesson_number = '$lessonNumber'";
$result_english_flashcard = mysqli_query($conn, $sql_english_flashcard);

$english_data = mysqli_fetch_all($result_english_flashcard, MYSQLI_ASSOC);

$totalPages = count($english_data);
...
<body>
    ...
    <h1>
        <?php echo $english_data[$currentPage]['subject']; ?>
    </h1>
    ...
    <script>
        ...
        var englishData = <?php echo json_encode($english_data); ?>;
        ...
        function updateContent() {
            ...
            term.textContent = englishData[currentPage]['term'];

            var popupContent = document.getElementById('popup-content');
            popupContent.textContent = englishData[currentPage]['definition'];
        }
