...
if (isset($_POST["lesson_number"])) {
    ...
    $insertquery = "INSERT INTO english(lesson_number, term, definition, added_by) VALUES (?, ?, ?, ?)";
...
if (isset($_POST['delete'])) {
    ...
    $deleteQuery = "DELETE FROM english WHERE lesson_number = '$lessonNumberToDelete' AND term = '$termToDelete' AND definition = '$definitionToDelete'";
...
<head>
    ...
    <title>Create: english Flashcard</title>
...
<body>
    ...
    <div class="container">
        <form method="POST">
            ...
            <input type="number" id="lesson_number" name="lesson_number" required style="width: 68%; height: 45px;">
            <br>
        ...
        <div class="card-container">
            ...
            $sql_select = "SELECT term, definition, lesson_number FROM english WHERE added_by = '$username'";
                ...
                while ($row_select = mysqli_fetch_assoc($result_select)) {
                    ...
                    <div class="card">
                        ...
                        <div class="term">
                            ...
                            <button style="width: 40px; font-size: 16px;"
                                onclick="speakText('<?php echo $row_select['term']; ?>', '<?php echo $row_select['definition']; ?>')">
