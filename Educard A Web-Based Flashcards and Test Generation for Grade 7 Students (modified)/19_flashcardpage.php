...
<header id="mainHeader">
    ...
    <h1 style="margin: 30px 30px 20px;">Terms from Lessons</h1>
    ...
    <div class="container">
        <div class="box" style="background-color:#D4FF9C;" onclick="redirectToPage('science/19_create.php');">
        ...
        <div class="box" style="background-color:#EEC781;" onclick="redirectToPage('filipino/19_create.php');">
            <h2 style="padding: 5px 20px;">Filipino</h2>
            <img src="https://i.imgur.com/69OCIwu.png"
                style="height: 80px; width: 60px; float: right; padding: 1px 20px; margin-top: -29px;">
        </div>

        <div class="box" style="background-color:#C68CE1;" onclick="redirectToPage('english/19_create.php');">
            <h2 style="padding: 5px 20px;">English</h2>
            <img src="https://i.imgur.com/LVPvnQc.png"
                style="height: 80px; width: 60px; float: right; padding: 1px 20px; margin-top: -29px;">
        </div>

        <div class="box" style="background-color:#EE8080;" onclick="redirectToPage('math/19_create.php');">
